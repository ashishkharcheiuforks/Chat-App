...
class MessageActivity : AppCompatActivity() {
    ...
    private fun navigateToUserProfile() {
        ...
        val p1:androidx.core.util.Pair<View,String> = androidx.core.util.Pair(profile_image,getString(R.string.profile_photo))
        val p2:androidx.core.util.Pair<View,String> = androidx.core.util.Pair(username,getString(R.string.userName))
        val p3:androidx.core.util.Pair<View,String> = androidx.core.util.Pair(userStatus,getString(R.string.userStatus))
