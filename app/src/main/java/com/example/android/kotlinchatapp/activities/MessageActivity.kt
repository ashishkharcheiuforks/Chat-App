...
import com.example.android.kotlinchatapp.adapter.MessageAdapter
        ...
        reference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (snapshot in dataSnapshot.children) {
                    ...
                    messageAdapter = MessageAdapter(this@MessageActivity, mChats, userImgURL,currentUser)
        ...
        if (filePath!=null){
            ...
            val urlTask=uploadTask?.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task->
                ...
                if (it.isSuccessful){
                    ...
                    Toasty.error(applicationContext,"failed to upload", Toasty.LENGTH_LONG).show()
                    progressDialog.hide()
                }
            }?.addOnFailureListener {
                Toasty.error(applicationContext!!,it.message.toString(), Toasty.LENGTH_LONG).show()
                progressDialog.hide()
            }
        }
        else{
